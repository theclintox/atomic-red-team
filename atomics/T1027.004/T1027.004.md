...
Invoke-WebRequest "https://github.com/theclintox/atomic-red-team/raw/master/atomics/T1027.004/src/calc.cs" -OutFile "#{input_file}"
```
...
##### Get Prereq Commands:
```powershell
Invoke-WebRequest https://github.com/theclintox/atomic-red-team/raw/master/atomics/T1027.004/bin/T1027.004_DynamicCompile.exe -OutFile #{input_file}
```
